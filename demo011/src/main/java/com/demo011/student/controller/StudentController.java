package com.demo011.student.controller;

import com.demo011.student.common.result.Result;
import com.demo011.student.entity.Student;
import com.demo011.student.service.StudentService;
...
/**
 * =====================================================================
 * 【demo010】Controller - MyBatis-Plus Service 版本
 * =====================================================================
 *
 * 上层调用方式完全不变，底层却越来越强大和简洁。
 * =====================================================================
 */
@Slf4j
@Component
public class StudentController {
    ...
    private void addStudent() {
        ...
        Result<Boolean> result = Result.success("新增成功", studentService.addStudent(s));
