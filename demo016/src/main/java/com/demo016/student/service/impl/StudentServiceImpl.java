package com.demo016.student.service.impl;

import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.demo016.student.common.exception.BusinessException;
import com.demo016.student.entity.Student;
import com.demo016.student.mapper.StudentMapper;
    ...
    public int batchAddStudents(java.util.List<Student> students) {
        ...
        for (Student student : students) {
            ...
            if (student.getName() != null && student.getName().contains("rollback")) {
                throw new com.demo016.student.common.exception.BusinessException(400, "模拟业务异常，触发事务回滚");
            }
