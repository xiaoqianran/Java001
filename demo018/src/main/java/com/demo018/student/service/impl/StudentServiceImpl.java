...
import com.demo018.student.common.exception.BusinessException;
import com.demo018.student.entity.Student;
import com.demo018.student.mapper.StudentMapper;
    ...
    public int batchAddStudents(java.util.List<Student> students) {
        ...
        for (Student student : students) {
            ...
            if (student.getName() != null && student.getName().contains("rollback")) {
                throw new com.demo018.student.common.exception.BusinessException(400, "模拟业务异常，触发事务回滚");
            }
