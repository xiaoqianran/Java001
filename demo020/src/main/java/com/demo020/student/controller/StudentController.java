package com.demo020.student.controller;

import com.demo020.student.common.log.TraceIdUtil;
import com.demo020.student.common.result.Result;
import com.demo020.student.controller.dto.StudentCreateDTO;
import com.demo020.student.controller.dto.StudentUpdateDTO;
import com.demo020.student.controller.vo.StudentVO;
import com.demo020.student.entity.Student;
import com.demo020.student.service.StudentService;
...
public class StudentController {
    ...
    public Result<StudentVO> getById(@PathVariable Long id) {
        ...
        return student != null 
                ? Result.success(convertToVO(student)) 
                : Result.error(404, "学生不存在");
    }

    // 简单转换方法（真实项目推荐使用 MapStruct）
    private StudentVO convertToVO(Student student) {
        StudentVO vo = new StudentVO();
        BeanUtils.copyProperties(student, vo);
        // 这里可以手动处理班级名称等关联查询（demo020 简化处理）
        return vo;
    }
