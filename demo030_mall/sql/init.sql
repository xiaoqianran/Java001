...
CREATE TABLE payment_order (
    ...
    refunded_amount DECIMAL(10,2) NOT NULL DEFAULT 0 COMMENT '已退款金额（Phase 12 新增）',
...
SELECT 'payment_order 表创建完成（Phase 9 - demo027_mall，Phase 10 新增已退款状态，Phase 12 新增 refunded_amount）' AS message;
...
CREATE TABLE refund_order (
    ...
    refund_amount  DECIMAL(10,2) NOT NULL COMMENT '申请退款金额（Phase 12 新增，支持部分退款）',
...
SELECT 'refund_order 表创建完成（Phase 11 - demo029_mall，Phase 12 新增 refund_amount）' AS message;
